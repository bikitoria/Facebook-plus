...
class FriendsViewModel: ObservableObject {
    @Published var users: [User] = [
        ...
        .init(id: "1", firstName: "Tina", familyName: "Belcher", email: "tina.belcher@gmail.com",profileImage: "tinaProfilePic", age: 15, gender: "female", friendsIds: [], friendRequestsIds: [], isCurrentUser: false),
